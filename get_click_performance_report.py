...
def getCMCDReport(client_customer_id, refresh_token, gclid=None):
    ...
    report = {
        ...
        'downloadFormat': 'XML',
        'selector': {
            'fields': ['GclId','CampaignId','ExternalCustomerId','ClickType','AdGroupId','CreativeId','CriteriaId','Device', 'AdNetworkType1','AdNetworkType2'],
            'dateRange': {'min':'20180622' , 'max':'20180622'},
        }
    }
    ...
    #         'field': 'ClickType',
    #         'operator': 'IN',
    #         'values': ['CALLS', 'CALL_TRACKING', 'MOBILE_CALL_TRACKING']
    #     }
    # ]
...
def main(id, token, env = 'dev', gclid = None):
...
if __name__ == '__main__':
    ...
    # main(args.client_customer_id, args.refresh_token, env=args.env, gclid=args.GclId)
    main(args.client_customer_id, args.refresh_token, env=args.env)
